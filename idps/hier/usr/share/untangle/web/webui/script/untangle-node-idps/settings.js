if (!Ung.hasResource["Ung.Idps"]) {
    Ung.hasResource["Ung.Idps"] = true;
    Ung.NodeWin.registerClassName('untangle-node-idps', 'Ung.Idps');

    // Preload indicator
    Ung.hasResource["Ung.Node.Ung.Idps"] = true;
