...
public abstract class WebFilterBase extends AppBase implements WebFilter
{
    ...
    protected void postInit()
    {
        ...
        if (readSettings.getVersion() < SETTINGS_CURRENT_VERSION) {
            ...
            addCategory(categories, 88, "Generate AI", "Productivity", "This category includes Artificial Intelligence tools and systems used to generate new text, images, video, audio, code, or other types of synthetic data. ", false, false, false);
    ...
    protected boolean addCategories(List<GenericRule> categories)
    {
        ...
        added |= addCategory(categories, 88, "Generate AI", "Productivity", "This category includes Artificial Intelligence tools and systems used to generate new text, images, video, audio, code, or other types of synthetic data. ", false, false, false);
        return added;
    }
    /**
     * Deploy the web app
