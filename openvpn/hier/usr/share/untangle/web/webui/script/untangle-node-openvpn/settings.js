                ...
                items: [{
                    ...
                    items: [{
                        ...
                        items: [{
                            ...
                            xtype: 'component',
                            html: this.i18n._('This file can be used to configured Chromebook clients.  On the target device, browse to <b>chrome://net-internals</b> and use Import ONC file.')
                        }, {
                            xtype: 'component',
