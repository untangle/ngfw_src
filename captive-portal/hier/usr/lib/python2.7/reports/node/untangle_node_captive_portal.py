...
class CaptivePortal(Node):
    ...
    def setup(self):
        ft = FactTable('reports.captive_portal_user_totals', 'reports.captive_portal_user_events', 'time_stamp', [], [])
        ...
        ft.measures.append(Column('captive_portal_blocks', 'integer', "count(CASE WHEN captive_portal_blocked THEN 1 ELSE null END)"))
...
FROM reports.captive_portal_user_totals
...
"""
        ...
        try:
            ...
            q, h = sql_helper.get_averaged_query(sums, "reports.captive_portal_user_totals",
                                                 start_date,
                                                 end_date,
...
FROM reports.captive_portal_user_events
