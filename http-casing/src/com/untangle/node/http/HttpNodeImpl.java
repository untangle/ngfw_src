...
{
    private final CasingPipeSpec pipeSpec = new CasingPipeSpec("http-casing", this, new HttpParser(true,this), new HttpParser(false,this), new HttpUnparser(true,this), new HttpUnparser(false,this), Fitting.HTTP_STREAM, Fitting.HTTP_TOKENS);
