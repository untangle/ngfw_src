...
- virus <TID> http <scan:true|false>
...
- virus <TID> extension-list
    -- Display virus scanning options for each specified file type for node TID
- virus <TID> extension-list add extension [scan:true|false] description
    -- Add a new item to the file-extension-list with specified settings.
- virus <TID> extension-list update [item-number] extension [scan:true|false] description
...
- virus <TID> mime-list add mime-type [scan:true|false] description
    -- Add a new item to the mime-type-list with specified settings.
- virus <TID> mime-list update [item-number] mime-type [scan:true|false] description
    -- Update item '[item-number]' with specified settings.
- virus <TID> mime-list remove [item-number]
    -- Remove item '[item-number]' from mime-type-list.
- virus <TID> [protocol:SMTP|POP|IMAP]
    -- Display email anti-virus protection options for node TID and the specified protocol.
- virus <TID> [protocol:SMTP|POP|IMAP] update [key:scan|action|description] new_value
...
- virus <TID> ftp-disable-resume <value:true|false>
    -- Display/Update 'disable FTP download resume' option for node TID.
- virus <TID> http-disable-resume <value:true|false>
