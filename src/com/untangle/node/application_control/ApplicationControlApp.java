...
public class ApplicationControlApp extends NodeBase
{
    ...
    private LinkedList<ApplicationControlLogicRule> buildDefaultRules()
    {
        ...
        LinkedList<ApplicationControlLogicRuleMatcher> matchers;
        ApplicationControlLogicRuleMatcher ruleMatcher1, ruleMatcher2, ruleMatcher3, ruleMatcher4;
        ApplicationControlLogicRuleAction action;

        rule = new ApplicationControlLogicRule();
        matchers = new LinkedList<ApplicationControlLogicRuleMatcher>();
        ruleMatcher1 = new ApplicationControlLogicRuleMatcher(ApplicationControlLogicRuleMatcher.MatcherType.PROTOCOL, "TCP");
        ruleMatcher2 = new ApplicationControlLogicRuleMatcher(ApplicationControlLogicRuleMatcher.MatcherType.DST_PORT, "443");
        ruleMatcher3 = new ApplicationControlLogicRuleMatcher(ApplicationControlLogicRuleMatcher.MatcherType.APPLICATION_CONTROL_PROTOCHAIN, "*/HTTP*", true);
        ...
        ruleMatcher1 = new ApplicationControlLogicRuleMatcher(ApplicationControlLogicRuleMatcher.MatcherType.PROTOCOL, "TCP");
        ruleMatcher2 = new ApplicationControlLogicRuleMatcher(ApplicationControlLogicRuleMatcher.MatcherType.DST_PORT, "443");
        ruleMatcher3 = new ApplicationControlLogicRuleMatcher(ApplicationControlLogicRuleMatcher.MatcherType.APPLICATION_CONTROL_PROTOCHAIN, "*/YOUTUBE*");
        matchers.add(ruleMatcher1);
        matchers.add(ruleMatcher2);
        matchers.add(ruleMatcher3);
        action = new ApplicationControlLogicRuleAction(ApplicationControlLogicRuleAction.ActionType.BLOCK, Boolean.TRUE);
        ...
        matchers = new LinkedList<ApplicationControlLogicRuleMatcher>();
        ruleMatcher1 = new ApplicationControlLogicRuleMatcher(ApplicationControlLogicRuleMatcher.MatcherType.PROTOCOL, "TCP");
        ruleMatcher2 = new ApplicationControlLogicRuleMatcher(ApplicationControlLogicRuleMatcher.MatcherType.DST_PORT, "80");
        ruleMatcher3 = new ApplicationControlLogicRuleMatcher(ApplicationControlLogicRuleMatcher.MatcherType.APPLICATION_CONTROL_PROTOCHAIN, "*/HTTP*", true);
        matchers.add(ruleMatcher1);
        matchers.add(ruleMatcher2);
        matchers.add(ruleMatcher3);
        ...
        matchers = new LinkedList<ApplicationControlLogicRuleMatcher>();
        ruleMatcher1 = new ApplicationControlLogicRuleMatcher(ApplicationControlLogicRuleMatcher.MatcherType.PROTOCOL, "TCP");
        ruleMatcher2 = new ApplicationControlLogicRuleMatcher(ApplicationControlLogicRuleMatcher.MatcherType.DST_PORT, "22");
        ruleMatcher3 = new ApplicationControlLogicRuleMatcher(ApplicationControlLogicRuleMatcher.MatcherType.APPLICATION_CONTROL_PROTOCHAIN, "*/SSH*", true);
        matchers.add(ruleMatcher1);
        matchers.add(ruleMatcher2);
        matchers.add(ruleMatcher3);
        action = new ApplicationControlLogicRuleAction(ApplicationControlLogicRuleAction.ActionType.BLOCK, Boolean.TRUE);
        ...
        rule = new ApplicationControlLogicRule();
        matchers = new LinkedList<ApplicationControlLogicRuleMatcher>();
        ruleMatcher1 = new ApplicationControlLogicRuleMatcher(ApplicationControlLogicRuleMatcher.MatcherType.APPLICATION_CONTROL_CATEGORY, "Proxy");
        matchers.add(ruleMatcher1);
