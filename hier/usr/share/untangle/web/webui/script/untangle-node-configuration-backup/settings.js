    ...
    buildStatus: function() {
        ...
        this.panelStatus = Ext.create('Ext.panel.Panel',{
            ...
            items: [this.buildAppStatus(), {
                ...
                xtype: 'fieldset',
                title: i18n._('Note'),
                html: Ext.String.format(i18n._('Configuration Backup automatically saves your configuration settings and sends them to {0} for safe storage. If you need a backup of your configuration settings, contact {1}'),
