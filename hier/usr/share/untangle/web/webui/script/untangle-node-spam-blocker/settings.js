Ext.define('Webui.untangle-node-spam-blocker.settings', {
    extend:'Ung.NodeWin',
    emailPanel: null,
    gridEventLog: null,
    gridDnsblEventLog: null,
    getAppSummary: function() {
        return i18n._("Spam Blocker uses multiple technologies to effectively protect against spam; even real-time spam outbreaks that are mass distributed over the Internet.");
    },
                            ...
                            "select": {
                                fn: Ext.bind(function(elem, record) {
                                    ...
                                    if (record.data.field1 == 0) {
                                        ...
                                        this.settings.smtpConfig.strength = record.data.field1;
                                    }
                ...
                },
                {
                    ...
                    items: [{
                        ...
                        listeners: {
                            "change": {
                                fn: Ext.bind(function(elem, checked) {
                                    this.settings.smtpConfig.greylist = checked;
                                }, this)
                            }
                        }
                    },{
...
//# sourceURL=spam-blocker-settings.js