Ext.define('Webui.bandwidth-control.settings', {
    ...
    setupWizard: function() {
        var welcomeCard = Ext.create('Webui.bandwidth-control.Wizard.Welcome', {
            i18n: i18n,
            gui: this
        });
        var wanBandwidthCard = Ext.create('Webui.bandwidth-control.Wizard.WAN', {
            i18n: i18n,
            gui: this
        });
        var defaultsCard = Ext.create('Webui.bandwidth-control.Wizard.Defaults', {
            i18n: i18n,
            gui: this
        });
        var quotaCard = Ext.create('Webui.bandwidth-control.Wizard.Quotas', {
            i18n: i18n,
            gui: this
        });
        var congratulationsCard = Ext.create('Webui.bandwidth-control.Wizard.Congratulations', {
            i18n: i18n,
            gui: this
        });
                    ...
                    handler: Ext.bind(function() {
                        ...
                        Ext.defer(function() {
                            if (this.bandwidthMonitorWin === undefined) {
                                this.bandwidthMonitorWin=Ext.create('Webui.bandwidth-control.Monitor',{
                                    parentCmp: this,
                            ...
                            var validLicense;
                            try {
                                validLicense = Ung.Main.getLicenseManager().getLicense('bandwidth-control').valid;
                            } catch (e) {
...
//Bandwidth Monitor
Ext.define('Webui.bandwidth-control.Monitor', {
...
Ext.define('Webui.bandwidth-control.Wizard.Welcome',{
...
Ext.define('Webui.bandwidth-control.Wizard.WAN',{
    constructor: function( config ) {
        Ext.apply(this, config);
...
Ext.define('Webui.bandwidth-control.Wizard.Defaults', {
    constructor: function( config ) {
        Ext.apply(this, config);
...
Ext.define('Webui.bandwidth-control.Wizard.Quotas', {
    constructor: function( config ) {
        Ext.apply(this, config);
...
Ext.define('Webui.bandwidth-control.Wizard.Congratulations',{
    constructor: function( config ) {
        Ext.apply(this, config);
