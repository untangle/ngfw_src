...
public class RemoteRebootJPanel extends JPanel implements ActionListener {
	...
	this.setLayout(new GridBagLayout());
        ...
        rebootJButton = new JButton("Reboot EdgeGuard");
	...
	rebootJLabel.setText("<html><center><b>Warning: </b>Clicking this button will reboot EdgeGuard, temporarily<br>interrupting network activity.</center></html>");
