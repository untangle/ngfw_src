...
public class RemotePublicAddressJPanel extends javax.swing.JPanel
	...
	((JSpinner.DefaultEditor)portJSpinner.getEditor()).getTextField().setBackground(Color.WHITE);
        ...
        private void initComponents() {//GEN-BEGIN:initComponents
                ...
                jLabel9.setText("<html> The Public Address must be set when Untangle is placed behind a Router on your network (it is not at the \"edge\" of your network).  This is the IP Address and port that will direct traffic to Untangle.  This will also be used in emails, etc., generated by Untangle, that will allow someone outside of the network to contact Untangle. </html>");
