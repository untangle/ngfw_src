...
public class DirectoryJDialog extends MConfigJDialog {
    ...
    private static final String NAME_REMOTE_ACTIVE_DIRECTORY   = "Active Directory (AD) Connector";
    ...
    protected void generateGui(){
        if (Util.getIsPremium(ProductIdentifier.ADDRESS_BOOK)) {
            ...
            addTab(NAME_REMOTE_ACTIVE_DIRECTORY, null, new PremiumJPanel());
        }
    ...
    private void setupJDialog()
    {
        ...
        try {
            compoundSettings = (CompoundSettings)compoundSettingsClass.newInstance();
        }
        catch(Exception e) {
