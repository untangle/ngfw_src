...
class CustomPolicyTableModel extends MSortedTableModel<PolicyCompoundSettings>{
    ...
    private String TIME_EXCLUDE = "Exclude selected time";
    private String TIME_INCLUDE = "Include selected time";
    ...
    private static final int C12_MW = 165; /* time range */
    ...
    public TableColumnModel getTableColumnModel(){
        ...
        addTableColumn( tableColumnModel,  12, C12_MW, true,  true,  false, false, ComboBoxModel.class, timeModel, sc.html("time period"));
	...
	for( Vector rowVector : tableVector ){
        ...
        boolean invertTime = ((String)((ComboBoxModel)rowVector.elementAt(12)).getSelectedItem()).equals(TIME_EXCLUDE);
