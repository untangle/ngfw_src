...
import com.untangle.node.web_filter.WebFilterApp;
...
public class WebFilterUnblockerServlet extends HttpServlet
{
        ...
        throws ServletException
    {
        ...
        WebFilterApp node = null;
        if ( node == null )
            try {node = (WebFilterApp) nm.node( Long.parseLong(request.getParameter( "tid" )) );} catch (Exception e) {}
        if ( node == null )
            try {node = (WebFilterApp) nm.node( Long.parseLong(request.getParameter( "appid" )) );} catch (Exception e) {}
