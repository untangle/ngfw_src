...
BuildEnv::SRC.installTarget.installJars(jt, "#{buildutil.distDirectory}/usr/share/metavize/lib")
BuildEnv::SRC.installTarget.installJars(Jars::Becl, "#{buildutil.distDirectory}/usr/share/java/mvvm")
