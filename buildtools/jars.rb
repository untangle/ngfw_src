...
class Jars
  ...
  def Jars.findJars
    ...
    const_set(:YUICompressor, [ Jars.downloadTarget('yuicompressor-2.4.2/yuicompressor-2.4.2/build/yuicompressor-2.4.2.jar') ])
    ...
    const_set(:Activation, [ Jars.downloadTarget('jaf-1.0.2/activation.jar') ])
