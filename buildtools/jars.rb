...
class Jars
  ...
  def Jars.findJars
    ...
    const_set(:Jabsorb, [ Jars.downloadTarget('jabsorb-1.2.6/jabsorb-1.2.6/jabsorb-1.2.6.jar')])
    const_set(:Json, [ Jars.downloadTarget('jabsorb-1.2.6/jabsorb-1.2.6/json.jar')])
