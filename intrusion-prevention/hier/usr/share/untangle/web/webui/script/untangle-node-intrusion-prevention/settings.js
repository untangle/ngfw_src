Ext.define('Webui.untangle-node-intrusion-prevention.settings', {
    extend:'Ung.NodeWin',
    statics: {
...
Ext.define('Webui.untangle-node-intrusion-prevention.Wizard.Welcome',{
...
Ext.define('Webui.untangle-node-intrusion-prevention.Wizard.Classtypes',{
    constructor: function( config ) {
        Ext.apply(this, config);
...
Ext.define('Webui.untangle-node-intrusion-prevention.Wizard.Categories',{
    constructor: function( config ) {
        Ext.apply(this, config);
