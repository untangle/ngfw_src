        ...
        return Report( 
            self, [
                SummarySection(
                    'summary', 
                    _('Summary Report'), [
                        IntrusionPreventionHighlight(self.name),
...
class IntrusionPreventionHighlight(Highlight):
    """
...
class IntrusionPreventionDetail(DetailSection):
    """
    Event log
    """
    def __init__(self):
