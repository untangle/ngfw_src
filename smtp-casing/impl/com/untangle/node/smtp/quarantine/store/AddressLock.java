...
class AddressLock {
    ...
    /**
     * Attempt to lock the given address but
     * if lock is not obtained after maxWait ms, give up
     *
     * @param address the <b>lower cased</b> address
    ...
    /**
     * Attempt to lock the given address and
     * if lock is not immediately obtained, give up
     *
     * @param address the <b>lower cased</b> address
     *
     ...
     * (and do not return until lock is obtained)
     *
     * @param address the <b>lower cased</b> address
     */
    ...
    synchronized void unlock(String address) {
        ...
        if(true == m_waiting) {
            // someone was waiting
            notifyAll(); // break them out of wait set (they will reset m_waiting)
        }
        return;
    }
