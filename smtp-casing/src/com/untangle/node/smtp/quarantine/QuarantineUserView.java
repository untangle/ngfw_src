...
public interface QuarantineUserView
    ...
    /**
     * Request that an email address (inbox) map to another.  This is
     * the gesture of someone "giving" their account to someone else (hence,
     * there aren't complex permission problems).
     * <br>
     * Note that it is up to the <b>calling</b> application to ensure the user
     * currently is logged-in as the source of the remap
     *
     * @param from the address to be redirected
     * @param to the target of the redirection
     *
     ...
     *
     * @param inboxName the name of the inbox which is currently <b>receiving</b> the
     *        remap.
     *
     * @param aliasToRemove the alias to no longer be remapped (and presumably
     ...
     *
     * @return the address to-which this is remapped, or null
     *         if this address is not remapped
     */
    public String getMappedTo(String account)
        throws QuarantineUserActionFailedException;

    /**
     * List any addresses for-which this account receives
     * redirection.
     *
     * @return all addresses redirected to this account,
     *         or a zero-length array if none are remapped.
     */
