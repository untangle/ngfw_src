/**
 * $Id: LinkGenerator.java 35079 2013-06-19 22:15:28Z dmorris $
 */
...
public class LinkGenerator
{
    ...
    {
        return appendNVP(m_urlBase, WebConstants.ACTION_RP, WebConstants.VIEW_INBOX_RV);
    }
    ...
    {
        return appendNVP(appendNVP(m_urlBase, WebConstants.ACTION_RP, WebConstants.RESCUE_RV), WebConstants.MAIL_ID_RP,
                mid);
    }
    ...
    {
        return appendNVP(appendNVP(m_urlBase, WebConstants.ACTION_RP, WebConstants.PURGE_RV), WebConstants.MAIL_ID_RP,
                mid);
    }
