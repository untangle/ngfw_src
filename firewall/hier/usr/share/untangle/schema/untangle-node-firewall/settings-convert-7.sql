...
UPDATE settings.n_firewall_rule SET src_intf_matcher = '255' WHERE src_intf_matcher = '7';
...
UPDATE settings.n_firewall_rule SET dst_intf_matcher = '255' WHERE dst_intf_matcher = '7';
