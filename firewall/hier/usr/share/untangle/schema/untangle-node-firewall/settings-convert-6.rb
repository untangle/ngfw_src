def update_schema()
  [
   ...
   "UPDATE settings.n_firewall_rule SET src_intf_matcher = 'any', dst_intf_matcher = 'more_external' WHERE inbound = false AND outbound = true",
   "UPDATE settings.n_firewall_rule SET src_intf_matcher = 'more_internal', dst_intf_matcher = 'any' WHERE inbound = true AND outbound = false",
