...
<!--
This added the nesting of sections to the top of the page, when more than one deep.  It got in the way of the niftier header I wish to create       
                <xsl:choose>
...
<!--
    <div style="background-image: url(figure/top-middle.png); width: 100%; height: 131px;">
      <div style="position: absolute; right: 0px;">
        <img src="figure/top-right-konqueror.png" style="margin: 0px" alt=""/>
      </div>
      <div style="position: absolute; left: 0px;">
        <img src="figure/top-left.png" style="margin: 0px" alt=""/>
      </div>
    ...
    <div style="margin-top: 20px; background-color: #white; color: black; margin-left: 20px; margin-right:20px;">
      <div style="position: absolute; left: 20px;">
        <a accesskey="p" href="other-consistency-issues.html">Prev</a>
      </div>
      <div style="position: absolute; right: 20px;">
        <a accesskey="n" href="more-hints.html">Next</a>
      </div>
      <div class="navCenter">
      </div>
    </div>
