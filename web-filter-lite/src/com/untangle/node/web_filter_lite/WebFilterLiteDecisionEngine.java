 ...
 */
class WebFilterLiteDecisionEngine extends DecisionEngine
{
    private static final Logger logger = Logger.getLogger( WebFilterLiteDecisionEngine.class );
    ...
    public WebFilterLiteDecisionEngine( WebFilterBase node )
    {
        super(node);
    }
    ...
    static
    {
        ...
        fileNames.add("/usr/share/untangle-web-filter-lite-init/aggressive-url");
        fileNames.add("/usr/share/untangle-web-filter-lite-init/dating-url");
        fileNames.add("/usr/share/untangle-web-filter-lite-init/drugs-url");
        fileNames.add("/usr/share/untangle-web-filter-lite-init/ecommerce-url");
        fileNames.add("/usr/share/untangle-web-filter-lite-init/gambling-url");
        fileNames.add("/usr/share/untangle-web-filter-lite-init/hacking-url");
        fileNames.add("/usr/share/untangle-web-filter-lite-init/jobsearch-url");
        fileNames.add("/usr/share/untangle-web-filter-lite-init/mail-url");
        fileNames.add("/usr/share/untangle-web-filter-lite-init/porn-url");
        fileNames.add("/usr/share/untangle-web-filter-lite-init/proxy-url");
        fileNames.add("/usr/share/untangle-web-filter-lite-init/socialnetworking-url");
        fileNames.add("/usr/share/untangle-web-filter-lite-init/sports-url");
        fileNames.add("/usr/share/untangle-web-filter-lite-init/vacation-url");
        fileNames.add("/usr/share/untangle-web-filter-lite-init/violence-url");
