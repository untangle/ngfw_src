Ext.define('Ung.apps.wireguard-vpn.view.Server', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.app-wireguard-vpn-server',
    itemId: 'server',
    title: 'Server'.t(),
    scrollable: true,
    ...
    //         xtype: 'app-wireguard-vpn-remote-clients-grid'
    //     },{
    //         title: 'Groups'.t(),
    //         itemId: 'groups',
    //         xtype: 'app-wireguard-vpn-groups-grid'
    //     },{
    //         title: 'Exported Networks'.t(),
    //         itemId: 'exported_networks',
    //         xtype: 'app-wireguard-vpn-exported-networks-grid'
    //     }]
    }]
});

// Ext.define('Ung.apps.wireguard-vpn.cmp.RemoteClientsGrid', {
//     extend: 'Ung.cmp.Grid',
//     alias: 'widget.app-wireguard-vpn-remote-clients-grid',
//     itemId: 'remote-clients-grid',
//     viewModel: true,
//     controller: 'app-wireguard-vpn-special',
...
//     emptyRow: {
//         javaClass: 'com.untangle.app.wireguard-vpn.OpenVpnRemoteClient',
//         'enabled': true,
//         'name': '',
//         'groupId': 1,
//         'export': false,
...
//         flex: 1,
//         dataIndex: 'groupId',
//         renderer: Ung.apps.wireguard-vpn.SpecialGridController.groupRenderer
//     }, {
//         xtype: 'actioncolumn',
...
// Ext.define('Ung.apps.wireguard-vpn.cmp.GroupsGrid', {
//     extend: 'Ung.cmp.Grid',
//     alias: 'widget.app-wireguard-vpn-groups-grid',
//     itemId: 'groups-grid',
//     viewModel: true,
...
//     emptyRow: {
//         javaClass: 'com.untangle.app.wireguard-vpn.OpenVpnGroup',
//         'enabled': true,
//         'name': '',
//         'groupId': -1,
//         'export': false
...
// Ext.define('Ung.apps.wireguard-vpn.cmp.ExportedNetworksGrid', {
//     extend: 'Ung.cmp.Grid',
//     alias: 'widget.app-wireguard-vpn-exported-networks-grid',
...
//     emptyRow: {
//         javaClass: 'com.untangle.app.wireguard-vpn.OpenVpnExport',
//         'enabled': true,
//         'name': '',
//         'network': ''
//     },
