...
class WireGuardVpnTests(NGFWTestCase):
    ...
    def test_032_netSettingsAndCustomWGNetworks(self):
        ...
        newWGSettings['networks'] = {"javaClass": "java.util.LinkedList", "list": [{"address": testingCustomWGAddr, "maskedAddress": testingCustomWGAddr, "javaClass": "com.untangle.app.wireguard_vpn.WireGuardVpnNetwork", "id": 1}]}
