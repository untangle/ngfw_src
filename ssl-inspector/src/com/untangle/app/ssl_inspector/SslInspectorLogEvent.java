...
public class SslInspectorLogEvent extends LogEvent
{
    ...
    public String toSummaryString()
    {
        String action;
        switch ( getStatus() ) {
        case "INSPECTED": action = I18nUtil.marktr("inspected"); break;
        case "IGNORED": action = I18nUtil.marktr("ignored"); break;
        case "BLOCKED": action = I18nUtil.marktr("blocked"); break;
        case "UNTRUSTED": action = I18nUtil.marktr("disallowed (untrusted)"); break;
        case "ABANDONED": action = I18nUtil.marktr("abandoned"); break;
