...
public class AdBlockerApp extends NodeBase
{
    ...
    public AdBlockerApp( NodeSettings nodeSettings, NodeProperties nodeProperties )
    {
        ...
        this.connector = UvmContextFactory.context().pipelineFoundry().create("ad-blocker-http", this, null, new AdBlockerHandler( this ), Fitting.HTTP_TOKENS, Fitting.HTTP_TOKENS, Affinity.CLIENT, 0);
    ...
    protected void postInit()
    {
        ...
        String settingsFileName = System.getProperty("uvm.settings.dir") + "/untangle-node-ad-blocker/" + "settings_" + nodeID + ".js";
    ...
    private void _setSettings(AdBlockerSettings newSettings)
    {
        ...
        String nodeID = this.getNodeSettings().getId().toString();
        try {
            settingsManager.save( System.getProperty("uvm.settings.dir") + "/" + "untangle-node-ad-blocker/" + "settings_" + nodeID + ".js", newSettings );
        } catch (SettingsManager.SettingsException e) {
