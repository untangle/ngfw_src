...
public class BoxBackupSummarizer extends BaseSummarizer {
    ...
    public String getSummaryHtml(Connection conn, Timestamp startDate, Timestamp endDate)
    {
        ...
        try {
            String sql = "select count(*) from tr_boxbackup_evt where time_stamp >= ? and time_stamp < ?";
            ...
            sql = "select count(*) from tr_boxbackup_evt where time_stamp >= ? and time_stamp < ? and blocked = 't'";
