...
class IDSTableModel extends MSortedTableModel<Object>{ 
    ...
    private static final int C2_MW = 55;  /* SID */
    private static final int C3_MW = 55;  /* on */
    private static final int C4_MW = 55;  /* log */
    private static final int C5_MW = 120; /* category */
    private static final int C6_MW = 120; /* class */
    private static final int C7_MW = 180; /* description */
    private static final int C8_MW = 120; /* info url */
    private static final int C9_MW = Util.chooseMax(T_TW - (C0_MW + C1_MW + C2_MW + C3_MW + C4_MW + C5_MW + C6_MW + C7_MW), 120); /* signature */
    ...
    public TableColumnModel getTableColumnModel(){
        ...
        addTableColumn( tableColumnModel,  2, C2_MW, false, false, false, false, Integer.class, null, "SID" );
        ...
        addTableColumn( tableColumnModel,  6, C6_MW, true,  false,  false, false, String.class,  "unclassified", "class");
        addTableColumn( tableColumnModel,  7, C7_MW, true,  false,  false, true,  String.class,  sc.EMPTY_DESCRIPTION, sc.TITLE_DESCRIPTION );
        addTableColumn( tableColumnModel,  8, C8_MW, true,  false,  false, false, String.class,  "http://", "info url");
	...
	for( Vector rowVector : tableVector ){            
	    newElem = (IDSRule) rowVector.elementAt(10);
            newElem.setSid( (Integer) rowVector.elementAt(2) );
	    ...
	    newElem.setClassification( (String) rowVector.elementAt(6) );
            newElem.setDescription( (String) rowVector.elementAt(7) );
            newElem.setURL( (String) rowVector.elementAt(8) );
            newElem.setText( (String) rowVector.elementAt(9) );
