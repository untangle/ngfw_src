 ...
 *
 * $Id: SpywareCookieEvent.java,v 1.4 2005/03/19 23:04:20 amread Exp $
 */
...
public class SpywareCookieEvent extends LogEvent
{
     ...
     *
     * @return if true the cookie was zeroed going to the server, otherwise it was removed going to the client
     * @hibernate.property
     * column="TO_SERVER"
     */
