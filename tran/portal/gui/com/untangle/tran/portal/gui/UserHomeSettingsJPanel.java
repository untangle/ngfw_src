...
public class UserHomeSettingsJPanel extends javax.swing.JPanel implements Savable<Object>, Refreshable<Object> {
	...
	try{ timeoutJSpinner.commitEdit(); }
        ...
        // SAVE THE VALUES ////////////////////////////////////
	if( !validateOnly ){
	    PortalHomeSettings portalHomeSettings = portalUser.getPortalHomeSettings();
	    if( enabled ){
		if( portalHomeSettings == null ){
		    portalHomeSettings = new PortalHomeSettings();
		    portalUser.setPortalHomeSettings( portalHomeSettings );
		}
		...
		portalUser.setPortalHomeSettings( null );
	    }
	}        
    }
	...
	((JSpinner.DefaultEditor)timeoutJSpinner.getEditor()).getTextField().setBackground(Color.WHITE);
        ...
        private void initComponents() {//GEN-BEGIN:initComponents
                ...
                setMinimumSize(new java.awt.Dimension(530, 474));
                setPreferredSize(new java.awt.Dimension(530, 474));
