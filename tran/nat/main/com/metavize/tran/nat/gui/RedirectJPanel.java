...
class RedirectTableModel extends MSortedTableModel{ 
    ...
    private ComboBoxModel actionModel = super.generateComboBoxModel( RedirectRule.getActionEnumeration(), RedirectRule.getActionDefault() );
    ...
    public void generateSettings(Object settings, boolean validateOnly) throws Exception {                
        ...
        for( Vector rowVector : (Vector<Vector>) this.getDataVector() ){
            ...
            redirectRule.setAction( ((ComboBoxModel) rowVector.elementAt(3)).getSelectedItem().toString() );
    ...
    public Vector generateRows(Object settings) {
	    ...
	    rowVector.add(super.generateComboBoxModel( RedirectRule.getActionEnumeration(), redirectRule.getAction().toString() ));
