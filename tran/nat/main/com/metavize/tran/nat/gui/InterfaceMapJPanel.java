...
class InterfaceTableModel extends MSortedTableModel<Object>{ 
    ...
    private static final int  C2_MW = 120;  /* ethernet interface */
    private static final int  C3_MW = 120;  /* net space */
    ...
    public TableColumnModel getTableColumnModel(){
        ...
        addTableColumn( tableColumnModel,  2,  C2_MW, true,  false, false, false, String.class, null, sc.html("ethernet<br>interface") );
        addTableColumn( tableColumnModel,  3,  C3_MW, true,  true,  false, false, ComboBoxModel.class, null, sc.html("net<br>space") );
	...
	Interface newElem = null;
	    ...
	    newElem.setNetworkSpace( (NetworkSpace) ((ComboBoxModel)rowVector.elementAt(3)).getSelectedItem() );
	...
	Vector tempRow = null;
	    ...
	    tempRow.add( super.generateComboBoxModel( networkSettings.getNetworkSpaceList(), intf.getNetworkSpace()) );
