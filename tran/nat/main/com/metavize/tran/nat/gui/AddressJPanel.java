...
class AddressTableModel extends MSortedTableModel{ 
    ...
    private static final int  C1_MW = Util.LINENO_MIN_WIDTH; /* status */
    private static final int  C2_MW = 130;  /* MAC address */
    private static final int  C3_MW = 100;  /* hostname */
    private static final int  C4_MW = 100; /* current IP */
    private static final int  C5_MW = 100; /* lease expiration */
    private static final int  C6_MW = 100;  /* static target IP */
    ...
    public TableColumnModel getTableColumnModel(){
        ...
        addTableColumn( tableColumnModel,  3,  C3_MW, true,  false, false, false, String.class, "", sc.html("hostname") );
        addTableColumn( tableColumnModel,  4,  C4_MW, true,  false, false, false, String.class, "", sc.html("current<br>IP address") );
        addTableColumn( tableColumnModel,  5,  C5_MW, true,  false, false, false, String.class, "", sc.html("lease end<br>date") );
        addTableColumn( tableColumnModel,  6,  C6_MW, true,  true,  false, false, String.class, "1.2.3.4", sc.html("target static<br>IP address") );
