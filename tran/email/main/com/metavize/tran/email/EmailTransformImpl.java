 ...
 *
 * $Id: EmailTransformImpl.java,v 1.14 2005/02/09 05:35:09 dmorris Exp $
 */
...
public class EmailTransformImpl extends SoloTransform implements EmailTransform
{
    ...
    public EmailTransformImpl()
    {
        ...
        pipeSpec = new PipeSpec("email", Fitting.OCTET_STREAM, smtpSub, Affinity.BEGIN);
    ...
    protected void initializeSettings()
    {
        ...
        spamInboundCtl.setActionOnDetect(Action.BLOCK);
