...
public class VirusEventJPanel extends MEditTableJPanel {
    
    
    public VirusEventJPanel(TransformContext transformContext) {

//         super();
//         super.setInsets(new Insets(4, 4, 2, 2));
//         super.setTableTitle("virus filter log");
//         super.setDetailsTitle("rule notes");
        
//         // create actual table model
//         VirusEventTableModel eventTableModel = new VirusEventTableModel(transformContext);
...
// class VirusEventTableModel extends MSortedTableModel{
//     private static final StringConstants sc = StringConstants.getInstance();    
    
//     VirusEventTableModel(TransformContext transformContext){
