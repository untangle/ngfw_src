...
class EmailTableModel extends MSortedTableModel{ 
    ...
    private MLDefinition tempElem = new MLDefinition();
    ComboBoxModel keyModel = super.generateComboBoxModel( tempElem.getFieldEnumeration(), tempElem.getField().toString() );
    ...
    public TableColumnModel getTableColumnModel(){
        ...
        addTableColumn( tableColumnModel,  3, C3_MW, false, true,  false, false, ComboBoxModel.class,  keyModel, sc.html("in this part<br>of the email"));
        addTableColumn( tableColumnModel,  4, C4_MW, false, true,  false, false, Boolean.class, "true", sc.bold("block if<br>found"));
	...
	for( Vector rowVector : (Vector<Vector>) this.getDataVector() ){
            ...
            MLDefinition newElem = new MLDefinition();
	...
	if( !validateOnly ){
	    ...
	    emailSettings.setFilters( elemList );
	}
	...
	for( MLDefinition newElem : (List<MLDefinition>) emailSettings.getFilters() ){

	    /* There is some action called exchange, which is not presentable*/
