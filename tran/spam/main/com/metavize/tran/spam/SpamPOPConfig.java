 ...
 */
public class SpamPOPConfig implements Serializable
{
    ...
    public SpamPOPConfig(boolean bScan, MessageAction zMsgAction, NotifyAction zNotifyAction, boolean bCopyOnBlock, String zNotes)
    {
        this.bScan = bScan;   
