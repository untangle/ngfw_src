...
class BlockTableModel extends MSortedTableModel{ 
    ...
    private static final int  C8_MW = 80;  /* source port */
    private static final int  C9_MW = 80;  /* destination port */
    ...
    public TableColumnModel getTableColumnModel(){
        ...
        addTableColumn( tableColumnModel, 10, C10_MW, true,  true,  true, false, String.class, sc.EMPTY_CATEGORY, sc.TITLE_CATEGORY);
