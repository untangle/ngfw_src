...
public class ClientToSiteConfigJPanel extends MEditTableJPanel {

    public ClientToSiteConfigJPanel() {
        super(true, true);
        ...
        ClientToSiteTableModel clientToSiteTableModel = new ClientToSiteTableModel();
        this.setTableModel( clientToSiteTableModel );
    }
}


class ClientToSiteTableModel extends MSortedTableModel{
