...
package com.untangle.tran.protofilter.reports;
...
public class SummaryGraph extends DayByMinuteTimeSeriesGraph
{
    ...
    public SummaryGraph(){          // out, in, total
        this("Traffic", true, true, "Clean/Passed", "Detected/Blocked", "Total", "Detected Protocols/min.");
    }
    ...
    protected JFreeChart doChart(Connection con) throws JRScriptletException, SQLException
    {
        ...
        while (rs.next()) {
            ...
            countA = rs.getLong(3) - rs.getLong(2);
            countB = rs.getLong(2);
            //countC = rs.getLong(3);
