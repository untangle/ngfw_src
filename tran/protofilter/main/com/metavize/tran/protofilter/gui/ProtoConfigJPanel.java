...
class ProtoTableModel extends MSortedTableModel{ 
	...
	ProtoFilterPattern tempPattern = new ProtoFilterPattern();
        ...
        addTableColumn( tableColumnModel,  5, C5_MW, false, true,  false, false, Boolean.class, "false", sc.bold("block"));
        addTableColumn( tableColumnModel,  6, C6_MW, false, true,  false, false, Boolean.class, "false", sc.bold("log"));
