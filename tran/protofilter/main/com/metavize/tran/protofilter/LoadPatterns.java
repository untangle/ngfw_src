...
public class LoadPatterns {
	...
	pats.put(220, new ProtoFilterPattern(220, "Battlefield 2", "Video Game", " An EA game.", "^(\\x11\\x20\\x01\\xa0\\x98\\x11|\\xfe\\xfd.?.?.?.?.?.?(\\x14\\x01\\x06|\\xff\\xff\\xff))|[\\x01\\x5c].?battlefield2", "ok notsofast", false,false,false));
	...
	pats.put(240, new ProtoFilterPattern(240, "Bittorrent", "Peer to Peer", " P2P filesharing / publishing tool - http://www.bittorrent.com", "^\\x13bittorrent protocol", "great veryfast", false,false,false));
	...
	pats.put(370, new ProtoFilterPattern(370, "Gkrellm", "System Administration", " a system monitor - http://gkrellm.net", "^<gkrellmd_setup>", "good veryfast", false,false,false));
	...
	pats.put(460, new ProtoFilterPattern(460, "HTTP", "Web", " iTunes (Apple's music program)", "http/(0\\.9|1\\.0|1\\.1).*(user-agent: itunes)", "good fast", false,false,false));
	pats.put(120, new ProtoFilterPattern(120, "RTSP tunneled within HTTP", "Streaming Video", "RTSP tunneled within HTTP", "^(get[\\x09-\\x0d -~]* Accept: application/x-rtsp-tunnelled|http/(0\\.9|1\\.0|1\\.1) [1-5][0-9][0-9] [\\x09-\\x0d -~]*a=control:rtsp://)", "ok notsofast", false,false,false));
	pats.put(460, new ProtoFilterPattern(460, "HTTP", "Web", " HyperText Transfer Protocol - RFC 2616", "http/(0\\.9|1\\.0|1\\.1) [1-5][0-9][0-9] [\\x09-\\x0d -~]*(connection:|content-type:|content-length:|date:)|post [\\x09-\\x0d -~]* http/[01]\\.[019]", "great notsofast", false,false,false));
	...
	pats.put(560, new ProtoFilterPattern(560, "MSN Messenger", "Instant Messenger", " Microsoft Network chat client", "ver [0-9]+ msnp[1-9][0-9]? [\\x09-\\x0d -~]*cvr0\\x0d\\x0a$", "good fast", false,false,false));
	...
	pats.put(630, new ProtoFilterPattern(630, "Nimda", "Worm", " a worm that attacks Microsoft IIS web servers, and MORE!", "GET (/scripts/root\\.exe\\?/c\\+dir|/MSADC/root\\.exe\\?/c\\+dir|/c/winnt/system32/cmd\\.exe\\?/c\\+dir|/d/winnt/system32/cmd\\.exe\\?/c\\+dir|/scripts/\\.\\.%5c\\.\\./winnt/system32/cmd\\.exe\\?/c\\+dir|/_vti_bin/\\.\\.%5c\\.\\./\\.\\.%5c\\.\\./\\.\\.%5c\\.\\./winnt/system32/cmd\\.exe\\?/c\\+dir|/_mem_bin/\\.\\.%5c\\.\\./\\.\\.%5c\\.\\./\\.\\.%5c\\.\\./winnt/system32/cmd\\.exe\\?/c\\+dir|/msadc/\\.\\.%5c\\.\\./\\.\\.%5c\\.\\./\\.\\.%5c/\\.\\.\\xc1\\x1c\\.\\./\\.\\.\\xc1\\x1c\\.\\./\\.\\.\\xc1\\x1c\\.\\./winnt/system32/cmd\\.exe\\?/c\\+dir|/scripts/\\.\\.\\xc1\\x1c\\.\\./winnt/system32/cmd\\.exe\\?/c\\+dir|/scripts/\\.\\.\\xc0/\\.\\./winnt/system32/cmd\\.exe\\?/c\\+dir|/scripts/\\.\\.\\xc0\\xaf\\.\\./winnt/system32/cmd\\.exe\\?/c\\+dir|/scripts/\\.\\.\\xc1\\x9c\\.\\./winnt/system32/cmd\\.exe\\?/c\\+dir|/scripts/\\.\\.%35c\\.\\./winnt/system32/cmd\\.exe\\?/c\\+dir|/scripts/\\.\\.%35c\\.\\./winnt/system32/cmd\\.exe\\?/c\\+dir|/scripts/\\.\\.%5c\\.\\./winnt/system32/cmd\\.exe\\?/c\\+dir|/scripts/\\.\\.%2f\\.\\./winnt/system32/cmd\\.exe\\?/c\\+dir)", "ok fast", false,false,false));
	...
	pats.put(880, new ProtoFilterPattern(880, "Tencent QQ Protocol", "Instant Messenger", " Chinese instant messenger protocol - http://www.qq.com", "^.?\\x02.+\\x03$", "good veryfast", false,false,false));
	...
	pats.put(130, new ProtoFilterPattern(130, "Quicktime HTTP", "Streaming Video", "Quicktime HTTP", "user-agent: quicktime \\(qtver=[0-9].[0-9].[0-9];os=[\\x09-\\x0d -~]+\\)\\x0d\\x0a", "good fast", false,false,false));
	...
	pats.put(770, new ProtoFilterPattern(770, "SIP", "Voice over IP", " Internet telephony - RFC 3261", "^(invite|register|cancel) sip[\\x09-\\x0d -~]*sip/[0-2]\\.[0-9]", "ok veryfast", false,false,false));
	...
	pats.put(790, new ProtoFilterPattern(790, "SNMP", "Networking", " Simple Network Management Protocol - RFC 1157", "^\\x02\\x01\\x04.+([\\xa0-\\xa3]\\x02[\\x01-\\x04].?.?.?.?\\x02\\x01.?\\x02\\x01.?\\x30|\\xa4\\x06.+\\x40\\x04.?.?.?.?\\x02\\x01.?\\x02\\x01.?\\x43)", "good veryfast", false,false,false));
	...
	pats.put(850, new ProtoFilterPattern(850, "Subspace", "Video Game", " 2D asteroids-style space game - http://beginners.subspace.net", "^\\x01....\\x11\\x10........\\x01$", "marginal veryfast", false,false,false));
	...
	pats.put(150, new ProtoFilterPattern(150, "SSL and TLS", "Networking", " Secure Socket Layer / Transport Layer Security - RFC 2246", "^(.?.?\\x16\\x03.*\\x16\\x03|.?.?\\x01\\x03\\x01?.*\\x0b)", "good fast", false,false,false));
	pats.put(140, new ProtoFilterPattern(140, "Valid certificate SSL", "Networking", "Valid certificate SSL", "^.?.?\\x01\\x03\\x01?.*\\x0b.*(thawte|equifax secure certificate authority|rsa data security, inc|verisign, inc|gte cybertrust root|entrust\\.net limited)", "good notsofast", false,false,false));
	...
	pats.put(980, new ProtoFilterPattern(980, "Xunlei", "Peer to Peer", " Chinese P2P filesharing - http://xunlei.com", "^[\\x28\\x29]...?.?.?(reg|get|query)", "good veryfast", false,false,false));
