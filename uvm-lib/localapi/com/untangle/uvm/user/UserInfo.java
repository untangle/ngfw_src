/*
 * $HeadURL: svn://chef/work/src/uvm-lib/localapi/com/untangle/uvm/user/UserInfo.java $
...
public class UserInfo
{
    ...
    public static final long DEFAULT_LIFETIME_MILLIS = 3 * 60 * 1000;
    ...
    /* generic helper */
    private UserInfo( long lookupKey, InetAddress address, Date lookupTime, String username, 
    ...
    {
        this.username = newValue.toLowerCase().trim(); /* XXX - should this to lower case? */
    ...
    public static UserInfo makeInstance( long lookupKey, InetAddress address )
    {
        return makeInstance( lookupKey, address, DEFAULT_LIFETIME_MILLIS );
    }

    public static UserInfo makeInstance( long lookupKey, InetAddress address, long lifetimeMillis )
    {
