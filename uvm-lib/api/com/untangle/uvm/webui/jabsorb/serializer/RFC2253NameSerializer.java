...
public class RFC2253NameSerializer extends AbstractSerializer {
	 ...
	 */
	private static Class[] _serializableClasses = new Class[] { RFC2253Name.class };
	...
	public Object marshall(SerializerState state, Object p, Object o)
        ...
        if( o == null ) {
            return "";
        } else if (o instanceof RFC2253Name) {
			return o.toString();
		}
	...
	public Object unmarshall(SerializerState state, Class clazz, Object json)
		...
		try {
			returnValue = RFC2253Name.parse(val);
		} catch (Exception e) {
			throw new UnmarshallException("Invalid \"RFC2253Name\" specified:"
					+ val);
		}
