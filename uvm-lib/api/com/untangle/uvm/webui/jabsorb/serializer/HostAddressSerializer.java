...
public class HostAddressSerializer extends AbstractSerializer {
	/**
	 * Classes that this can serialise.
	 */
	private static Class[] _serializableClasses = new Class[] { HostAddress.class };
	...
	public Object marshall(SerializerState state, Object p, Object o)
        ...
        if( o == null ) {
            return "";
        } else if (o instanceof HostAddress) {
			return o.toString();
		}
	...
	public Object unmarshall(SerializerState state, Class clazz, Object json)
		...
		try {
			returnValue = HostAddress.parse(val);
		} catch (Exception e) {
			throw new UnmarshallException("Invalid \"HostAddress\" specified:"
					+ val);
		}
