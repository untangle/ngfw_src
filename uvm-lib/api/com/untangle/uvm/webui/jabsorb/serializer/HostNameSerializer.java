...
public class HostNameSerializer extends AbstractSerializer {
	 ...
	 */
	private static Class[] _serializableClasses = new Class[] { HostName.class };
	...
	public Object unmarshall(SerializerState state, Class clazz, Object json)
		...
		try {
			returnValue = HostName.parseStrict(val);
		} catch (Exception e) {
			throw new UnmarshallException("Invalid \"HostName\" specified:"
					+ val);
		}
