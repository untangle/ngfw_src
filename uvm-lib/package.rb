...
## Local API
jts << JarTarget.build_target(uvm_lib, Jars::Base + Jars::Jabsorb + [uvm_lib['api']], 'localapi', "./uvm-lib/localapi")
...
BuildEnv::SRC.installTarget.install_jars(Jars::Jabsorb, "#{thirdparty.distDirectory}/usr/share/java/uvm")
