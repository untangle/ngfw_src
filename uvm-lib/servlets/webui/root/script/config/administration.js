                ...
                items: [{
                    ...
                    items : [{
                        ...
                        items: [{
                            ...
                            layout: 'form',
                            items: [{
                                html : this.i18n._("Click this button to import a signed certificate which has been generated by a certificate authority, and was based on a previous signature request from Untangle."),
                                border : false
                            }]
                        }]
                    }]
        ...
        buildGenerateCertGenTrusted : function() {
            this.panelGenerateCertGenTrusted = new Ext.Panel({
                ...
                items: {
                    ...
                    autoHeight : true,
                    items : [{
                        html : this.i18n._('Click the Proceed button to generate a signature below.  ' +
                        		'Copy the signature (Control-C), and paste it into the necessary form ' +
                        		'from your Certificate Authority (Verisign, Thawte, etc.).'),
                        bodyStyle : 'padding-bottom:10px;',
                        border : false
                    },{
                        xtype : 'textarea',
