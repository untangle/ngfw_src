...
Ung.AppItem = Ext.extend(Ext.Component, {
	...
	getNodeName: function() {
		...
		} else if(this.trialItem) { // for libitems with trial nodes return trial node name
...
Ung.JsonListReader = Ext.extend(Ext.data.JsonReader, {
    readRecords : function(o){
    	...
    	var records = [];
    	this.getRoot = this.meta.root ? this.getJsonAccessor(this.meta.root) : function(p){return p;};
