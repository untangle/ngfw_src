...
if HadesBuildEnv.isDevel
  LicenseBuilder::License.new( license_manager, "upm-dev", "untangle-license-manager", 
                               'untangle-node-license', LicenseBuilder::Developer )
...
HadesBuildEnv.installTarget.install_jars(j, "#{license_manager.distDirectory}/usr/share/untangle/lib",
                                         nil, false, true)
