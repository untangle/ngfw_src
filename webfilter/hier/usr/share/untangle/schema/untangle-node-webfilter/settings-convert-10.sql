...
ALTER TABLE settings.n_webfilter_passed_urls ALTER COLUMN position DROP NOT NULL;

ALTER TABLE settings.n_webfilter_extensions DROP CONSTRAINT n_webfilter_extensions_pkey;
ALTER TABLE settings.n_webfilter_extensions ALTER COLUMN position DROP NOT NULL;

ALTER TABLE settings.n_webfilter_mime_types DROP CONSTRAINT n_webfilter_mime_types_pkey;
ALTER TABLE settings.n_webfilter_mime_types ALTER COLUMN position DROP NOT NULL;

ALTER TABLE settings.n_webfilter_passed_clients DROP CONSTRAINT n_webfilter_passed_clients_pkey;
ALTER TABLE settings.n_webfilter_passed_clients ALTER COLUMN position DROP NOT NULL;

ALTER TABLE settings.n_webfilter_blocked_urls DROP CONSTRAINT n_webfilter_blocked_urls_pkey;
ALTER TABLE settings.n_webfilter_blocked_urls ALTER COLUMN position DROP NOT NULL;
