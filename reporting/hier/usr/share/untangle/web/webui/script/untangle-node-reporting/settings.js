if (!Ung.hasResource["Ung.Reporting"]) {
  ...
  Ung.Reporting = Ext.extend(Ung.NodeWin, {
                               ...
                               buildStatus: function() {
                                 this.panelStatus = new Ext.Panel({ title: this.i18n._('Status'),
                                                                    name: 'Status',
                                                                    helpSource: 'status',
                                                                    layout: "form",
                                                                    autoScroll: true,
                                                                    cls: 'ung-panel',
                                                                    items: [{ title: this.i18n._('Status'),
                                                                              xtype: 'fieldset',
                                                                              autoHeight: true,
                                                                              items: [{ buttonAlign: 'center',
                                                                                        footer: false,
                                                                                        border: false,
                                                                                        buttons: [{ xtype: 'button',
                                                                                                    ...
                                                                                                    handler: function() {
                                                                                                      ...
                                                                                                      var breadcrumbs = [{ title: i18n._(rpc.currentPolicy.name),
                                                                                                                           action: function() {
