...
public interface AddressBook
{
     ...
     * com.metavize.mvvm.addrbook.RepositoryType#NONE NONE} if not
     * found.
     * @exception ServiceUnavailableException the back-end directory
     * is in a bad state.  There are no corrective actions the caller
     ...
     * #com.metavize.mvvm.addrbook.UserEntry#getStoredIn getStoredIn}
     * property is ignored.
     *
     ...
     * com.metavize.mvvm.addrbook.UserEntry#getUID uid}) of the
     * passed-in entry.  Note that the {@link
     * com.metavize.mvvm.addrbook.UserEntry#getStoredIn storedIn}
     * property is ignored, and implicitly {@link
     * com.metavize.mvvm.addrbook.RepositoryType#LOCAL_DIRECTORY
