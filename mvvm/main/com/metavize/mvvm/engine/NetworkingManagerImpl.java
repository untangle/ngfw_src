...
class NetworkingManagerImpl implements NetworkingManager
{
    ...
    private static final byte   INTF_VPN_NUM  = 3;
    private static final String INTF_VPN_NAME  = "VPN";
    ...
    private static final String[] INTF_ARRAY_DMZ    = 
        new String[]{ INTF_EXTERNAL_NAME, INTF_INTERNAL_NAME, INTF_DMZ_NAME, INTF_VPN_NAME };
