...
public final class IntfConverter
{
    ...
    public static final byte  NETCAP_ERROR    = IntfConstants.NETCAP_ERROR;
    public static final byte  NETCAP_LOOPBACK = IntfConstants.NETCAP_LOOPBACK;
    public static final byte  NETCAP_UNKNOWN  = IntfConstants.NETCAP_UNKNOWN;
    ...
    byte[] argonIntfArray()
    {
        byte copy[] = new byte[argonIntfArray.length];

        System.arraycopy( argonIntfArray, 0, copy, 0, argonIntfArray.length );
        return copy;
    }

    byte[] netcapIntfArray()
    {
        byte copy[] = new byte[netcapIntfArray.length];

        System.arraycopy( netcapIntfArray, 0, copy, 0, netcapIntfArray.length );
        return copy;
    }
