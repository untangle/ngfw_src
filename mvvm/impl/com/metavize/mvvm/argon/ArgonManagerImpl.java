...
/* XXX - RBS
 * The remote shield manager should probably be broken out,
 * But then again ArgonManager should probably be moved into engine.
 * This will require some disecting to move the private parts and the
 * non-private parts
 */
public class ArgonManagerImpl implements ArgonManager, RemoteShieldManager
{    
