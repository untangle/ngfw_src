...
class MailSenderImpl implements MailSender
{
    ...
    public static final String TEST_MESSAGE_SUBJECT = "Untangle Platform test message";
    public static final String TEST_MESSAGE_BODY =
        "Success!\r\n\r\n" +
        "This automated message was generated by the Untangle Networks Platform\r\n" +
    ...
    private static final String MASQMAIL_CONF_START =
        "# AUTOGENERATED BY UNTANGLE NETWORKS DO NOT MODIFY MANUALLY\n\n" +
        "local_nets=\"\"\n" +
    ...
    */
    ...
    {
        String subject = "Untangle Networks Platform Reports"; // XXX Make default unsuck.
