...
request.setAttribute( "i18n_map", uvm.languageManager().getTranslations("untangle-node-directory-connector")); 
%>
...
<div id="main">
 ...
 <!-- Content Start -->
    ...
    <div class="un_login_head">
        <a href="<%=companyUrl%>"><img src="/images/BrandingLogo.png" border="0" alt="<%=company%> logo"/></a> <div><uvm:i18n>User Notification Login Script</uvm:i18n></div>
    </div>
