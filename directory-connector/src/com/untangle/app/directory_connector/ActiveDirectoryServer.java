...
public class ActiveDirectoryServer implements java.io.Serializable, JSONString
{
     ...
     *
     * @param superuser     Server username
     * @param superuserPass     Server username password
     * @param domain    AD Domain
     * @param ldapHost  AD hostname
     * @param ldapPort  AD port.  363 for non-secure, 636 for secure.
     * @param ldapSecure    true to access securely, false to use non-secure mode.
     */
    public ActiveDirectoryServer(String superuser, String superuserPass, String domain, String ldapHost, int ldapPort, boolean ldapSecure)
    {
     ...
     *
     * @return true if server is enabled, otherwise false
     */
    public boolean getEnabled() { return isEnabled; }
    /**
     * Sets whether server is enabled.
     *
     * @param isEnabled true if server is enabled, otherwise false
     */
     ...
     *
     * @return IP reachable server name.  This can be a hostname or IP address.
     */
    public String getLDAPHost() { return ldapHost; }
    /**
     * Sets IP reachable server name.
     *
     * @param ldapHost IP reachable server name.  This can be a hostname or IP address.
     */
     ...
     *
     * @return server TCP port.  Usually 363 for non-secure, 636 for secure.
     */
    public int getLDAPPort() { return ldapPort; }
    /**
     * Sets server TCP port.
     *
     * @param port server TCP port.  Usually 363 for non-secure, 636 for secure.
     */
     ...
     *
     * @return true if secure LDAP is enabled, otherwise false
     */
    public boolean getLDAPSecure() { return ldapSecure; }
    /**
     * Set true if secure LDAP is enabled.
     *
     * @param secure true if secure LDAP is enabled, otherwise false
     */
     ...
     * Return OU filters
     *
     * @return List of OU filters.
     */
    public List<String> getOUFilters() { return ouFilters; }
    /**
     * Set OU filters
     *
     * @param ouFilters List of OU filters.
     */
     ...
     *
     * @return Server settings in JSON form.
     */
