...
import com.untangle.node.directory_connector.RadiusSettings;
...
public class RadiusLdapAdapter
{
    ...
    private RadiusClient getNewClient() throws SocketException, UnknownHostException
    {
        ...
        synchronized ( this ) {
            ...
            int timeout = Integer.getInteger("com.untangle.node.directory_connector.radius.timeout-ms", 4000);
