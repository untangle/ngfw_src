...
ALTER TABLE settings.n_webfilter_settings ADD COLUMN unblock_password_enabled bool;
UPDATE settings.n_webfilter_settings SET unblock_password_enabled = false;
ALTER TABLE settings.n_webfilter_settings ALTER COLUMN unblock_password_enabled SET NOT NULL;

ALTER TABLE settings.n_webfilter_settings ADD COLUMN unblock_password_admin bool;
UPDATE settings.n_webfilter_settings SET unblock_password_admin = false;
