 ...
 * <code>LogoutReason</code> objects.
 *
 * @author <a href="mailto:amread@untangle.com">Aaron Read</a>
 * @version 1.0
 */
public class LogoutReasonUserType implements UserType
{
    private static final int[] SQL_TYPES = { Types.CHAR };

    public int[] sqlTypes() { return SQL_TYPES; }
    public Class<LogoutReason> returnedClass() { return LogoutReason.class; }
        ...
        throws HibernateException, SQLException
    {
        ...
        if (rs.wasNull() || 1 != s.length()) {
            ...
            return LogoutReason.getInstance(s.charAt(0));
        }
    }
