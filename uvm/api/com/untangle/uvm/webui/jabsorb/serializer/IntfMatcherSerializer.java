...
public class IntfMatcherSerializer extends AbstractSerializer
{
     ...
     */
    private static Class[] _serializableClasses = new Class[] { IntfMatcher.class };
    ...
    {
        if (o instanceof IntfMatcher) {
            return ((IntfMatcher) o).toDatabaseString();
        }
        return null;
    }
        ...
        throws UnmarshallException
    {
        ...
        try {
            returnValue = new IntfMatcher(val);
        } catch (Exception e) {
