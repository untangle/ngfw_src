/**
 * $Id: DistinguishedNameSerializer.java,v 1.00 2013/02/26 18:44:22 dmorris Exp $
 */
...
public class DistinguishedNameSerializer extends AbstractSerializer {
	 ...
	 */
	private static Class[] _serializableClasses = new Class[] { DistinguishedName.class };
	...
	public Object unmarshall(SerializerState state, Class clazz, Object json)
		...
		try {
			returnValue = DistinguishedName.parse(val);
		} catch (Exception e) {
			throw new UnmarshallException("Invalid \"DistinguishedName\" specified:"
					+ val);
		}
