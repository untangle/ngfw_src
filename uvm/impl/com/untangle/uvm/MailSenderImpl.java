...
public class MailSenderImpl implements MailSender
{
    ...
    public String sendTestMessage(String recipient)
    {
        ...
        String testMessageBody = i18nUtil.tr("Success!")
                + "\r\n\r\n"
                + i18nUtil
                        .tr("This automated message was generated by the {0} Server{1}to confirm that your email settings are correct.",
        ...
        try {
            ...
            try { if (br != null) br.close(); } catch (IOException x) { }
        }
    }
    ...
    // Here's where we actually do the sending
    private void dosend(Session session, Message msg, Address[] recipients, final List<String> messageId)
        throws MessagingException
    {
        ...
        try {
            ...
            try { if (transport != null) transport.removeTransportListener(tl); } catch (Exception x) { }
    ...
    /**
     * Parse the exim log lines in order to find the logs regarding a given message
     * identified by an ID
     */
