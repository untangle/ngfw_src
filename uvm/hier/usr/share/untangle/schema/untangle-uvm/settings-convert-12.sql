...
UPDATE settings.u_node_persistent_state SET name = 'ips-node' WHERE name = 'ids-transform';
UPDATE settings.u_node_persistent_state SET name = 'sigma-node' WHERE name = 'sigma-transform';
UPDATE settings.u_node_persistent_state SET name = 'spamassassin-node' WHERE name = 'spamassassin-transform';
UPDATE settings.u_node_persistent_state SET name = 'reporting-node' WHERE name = 'reporting-transform';
UPDATE settings.u_node_persistent_state SET name = 'protofilter-node' WHERE name = 'protofilter-transform';
UPDATE settings.u_node_persistent_state SET name = 'clam-node' WHERE name = 'clam-transform';
UPDATE settings.u_node_persistent_state SET name = 'test-node' WHERE name = 'test-transform';
UPDATE settings.u_node_persistent_state SET name = 'nat-node' WHERE name = 'nat-transform';
UPDATE settings.u_node_persistent_state SET name = 'spyware-node' WHERE name = 'spyware-transform';
UPDATE settings.u_node_persistent_state SET name = 'firewall-node' WHERE name = 'firewall-transform';
UPDATE settings.u_node_persistent_state SET name = 'shield-node' WHERE name = 'airgap-transform';
UPDATE settings.u_node_persistent_state SET name = 'phish-node' WHERE name = 'clamphish-transform';
UPDATE settings.u_node_persistent_state SET name = 'kav-node' WHERE name = 'kav-transform';
UPDATE settings.u_node_persistent_state SET name = 'portal-node' WHERE name = 'portal-transform';
UPDATE settings.u_node_persistent_state SET name = 'hauri-node' WHERE name = 'hauri-transform';
UPDATE settings.u_node_persistent_state SET name = 'boxbackup-node' WHERE name = 'boxbackup-transform';
