...
file.write("deb http://%s:untangle@%s/public/%s %s main premium non-free upstream" % (uid, UPDATE_SERVER, debian_distro, CURRENT_STABLE)+ "\n")
file.write("deb http://%s:untangle@%s/public/%s %s main premium non-free upstream" % (uid, UPDATE_SERVER, debian_distro, CURRENT_NAME)+ "\n")
file.flush()
file.close()
