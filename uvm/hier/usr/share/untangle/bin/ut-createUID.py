...
file.write("deb http://%s:untangle@%s/public/%s %s main non-free upstream" % (uid, UPDATE_SERVER, "jessie", CURRENT_STABLE)+ "\n")
file.write("deb http://%s:untangle@%s/public/%s %s main non-free upstream" % (uid, UPDATE_SERVER, "jessie", CURRENT_NAME)+ "\n")
file.flush()
file.close()
