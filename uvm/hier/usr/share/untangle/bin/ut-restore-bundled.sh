...
# restores it to a system.  This is a wrapper around "ut-restore-files"
...
# Invoke ut-restore-files ("Usage: $0 dumpfile tarfile instfile")

    @UVM_HOME@/bin/ut-restore-files $WORKING_DIR/$DB_FILE $WORKING_DIR/$FILES_FILE $WORKING_DIR/$INSTALLED_FILE
