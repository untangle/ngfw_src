            ...
            this.panelCertificates = Ext.create('Ext.panel.Panel',{
                ...
                items: [{
                    ...
                    items: [{
                        xtype: 'displayfield',
                        margin: '5 0 5 0',
                        value:  'The Certificate Authority is used to create and sign the HTTPS certificates used by several applications and services ' +
                                'such as HTTPS Inspector and Captive Portal.  It can also be used to sign the internal web server certificate.' +
                    ...
                    items: [{
                        xtype: 'displayfield',
                        margin: '5 0 5 0',
                        value:  'The Server Certificate is used to secure all HTTPS connections with this server.  There are two options for creating ' +
                                'this certificate.  You can create a certificate signed by the Certificate Authority created and displayed above, or ' +
                                'you can purchase a certificate that is signed by a third party certificate authority such as Thawte, Verisign, etc.'
                    },{
                        xtype: 'textfield',
                        fieldLabel: this.i18n._('Valid starting'),
                        labelStyle: 'font-weight:bold',
                        ...
                        items: [{
                            ...
                            margin: '0 5 0 5',
                            columnWidth: 1,
                            value: 'Click here to create a server certificate signed by the Certificate Authority displayed above.  Use this to change the information in the Subject DN of the server certificate.'
                        }]
                    }]
                },{
                    ...
                    items: [{
                        xtype: 'displayfield',
                        margin: '5 0 5 0',
                        value:  'To use a server certificate signed by a third party certificate authority, you must first generate a Certificate ' +
                                'Signing Request (CSR) using the first button below.  This will allow you to create a new CSR which will be ' +
                                'downloaded to your computer.  You will provide this file to the certificate vendor of your choice, and they will ' +
                                'use it to create a signed server certificate which you can import using the second button below.'
                    },{
                        xtype: 'fieldset',
                        layout: 'column',
                        items: [{
                            ...
                            margin: '0 5 0 5',
                            minWidth: 200,
                            text: 'Create Signature Signing Request',
                            iconCls: 'action-icon',
                            handler: Ext.bind(function() {
                                this.certGeneratorPopup("CSR", this.getHostname(true), "Create Signature Signing Request");
                            }, this)
                        },{
                            xtype: 'displayfield',
                            margin: '0 5 0 5',
                            columnWidth: 1,
                            value: 'Click here to generate and download a new Certificate Signing Request (CSR) to your computer.'
                        }]
                    },{
                        xtype: 'fieldset',
                        layout: 'column',
                        items: [{
                            ...
                            margin: '0 5 0 5',
                            columnWidth: 1,
                            value: 'Click here to upload a signed server certificate that you received from the CSR you created in step one.'
                        }]
                    }]
                }]
            });
