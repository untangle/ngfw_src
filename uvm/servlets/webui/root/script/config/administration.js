                        ...
                        items: [{
                            ...
                            items: [{
                                ...
                                handler: Ext.bind(function() {
                                    this.onGenerateSelfSignedCertificate();
                                }, this)
                            }]
                        },{
                            border: false,
            ...
            if(!this.winGenerateSelfSignedCertificate) {
                this.winGenerateSelfSignedCertificate = Ext.create('Ung.CertGenerateWindow', {
                    ...
                    cancelAction: function() {
                        ...
                        Ext.getCmp('administration_organizationUnit').reset();
                        Ext.getCmp('administration_city').reset();
                        Ext.getCmp('administration_state').reset();
                        Ext.getCmp('administration_country').reset();
                        this.hide();
                    }
                });
                this.subCmps.push(this.winGenerateSelfSignedCertificate);
            }
