Ext.define ('Ung.model.Session', {
    ...
    fields: [
        ...
        { name: 'clientBps', type: 'number', convert: function (val) { return val ? Math.round(val*1000)/1000 : null; } },
        ...
        { name: 'serverBps', type: 'number', convert: function (val) { return val ? Math.round(val*1000)/1000 : null; } },
        ...
        { name: 'totalBps', type: 'number', convert: function (val) { return val ? Math.round(val*1000)/1000 : null ; } },
    ],
    proxy: {
        autoLoad: true,
        type: 'memory',
