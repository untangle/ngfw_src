Ext.define('Ung.store.Conditions', {
    ...
    data: [
        ...
        {name:"HTTP_REQUEST_METHOD",displayName: 'HTTP: Request Method'.t(), type: "text", visible: true},
        {name:"WEB_FILTER_REQUEST_METHOD",displayName: 'HTTP: Request Method'.t(), type: "text", visible: false},
        {name:"HTTP_REQUEST_FILE_PATH",displayName: 'HTTP: Request File Path', type: "text", visible: true},
        {name:"WEB_FILTER_REQUEST_FILE_PATH",displayName: 'HTTP: Request File Path'.t(), type: "text", visible: false},
        {name:"HTTP_REQUEST_FILE_NAME",displayName: 'HTTP: Request File Name'.t(), type: "text", visible: true},
        {name:"WEB_FILTER_REQUEST_FILE_NAME",displayName: 'HTTP: Request File Name'.t(), type: "text", visible: false},
        {name:"HTTP_REQUEST_FILE_EXTENSION",displayName: 'HTTP: Request File Extension'.t(), type: "text", visible: true},
        {name:"WEB_FILTER_REQUEST_FILE_EXTENSION",displayName: 'HTTP: Request File Extension'.t(), type: "text", visible: false},
        {name:"HTTP_CONTENT_TYPE",displayName: 'HTTP: Content Type'.t(), type: "text", visible: true},
        {name:"WEB_FILTER_RESPONSE_CONTENT_TYPE",displayName: 'HTTP: Content Type'.t(), type: "text", visible: false},
        {name:"HTTP_RESPONSE_FILE_NAME",displayName: 'HTTP: Response File Name'.t(), type: "text", visible: true},
        {name:"WEB_FILTER_RESPONSE_FILE_NAME",displayName: 'HTTP: Response File Name'.t(), type: "text", visible: false},
        {name:"HTTP_RESPONSE_FILE_EXTENSION",displayName: 'HTTP: Response File Extension'.t(), type: "text", visible: true},
        {name:"WEB_FILTER_RESPONSE_FILE_EXTENSION",displayName: 'HTTP: Response File Extension'.t(), type: "text", visible: false},
