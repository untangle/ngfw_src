Ext.define('Ung.util.Util', {
    ...
    //     'application-control':  { node: 'untangle-node-application-control' },
    //     'bandwidth-control':    { node: 'untangle-node-bandwidth-control' },
    //     'branding-manager':     { node: 'untangle-node-branding-manager' },
    //     'captive-portal':       { node: 'untangle-node-captive-portal' },
    //     'configuration-backup': { node: 'untangle-node-configuration-backup' },
    //     'directory-connector':  { node: 'untangle-node-directory-connector' },
    //     'firewall':             { node: 'untangle-node-firewall' },
    // },
    ...
    //     'ad-blocker': 'untangle-node-ad-blocker',
