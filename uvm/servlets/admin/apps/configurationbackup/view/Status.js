Ext.define('Ung.apps.configurationbackup.view.Status', {
    ...
    alias: 'widget.app-configurationbackup-status',
    itemId: 'status',
    title: 'Status'.t(),
    ...
    items: [{
        ...
        items: [{
            xtype: 'component',
            cls: 'app-desc',
            html: '<img src="/skins/modern-rack/images/admin/apps/untangle-node-configuration-backup_80x80.png" width="80" height="80"/>' +
