Ext.define('Ung.apps.applicationcontrol.view.Rules', {
    ...
    conditions: [
        ...
        { name: 'CLIENT_HOSTNAME', displayName: 'Client Hostname'.t(), type: 'text', visible: true },
        ...
        { name: 'CLIENT_QUOTA_ATTAINMENT', displayName: 'Client Quota Attainment'.t(), type: 'text', visible: true },
        { name: 'SERVER_QUOTA_ATTAINMENT', displayName: 'Server Quota Attainment'.t(), type: 'text', visible: true },
