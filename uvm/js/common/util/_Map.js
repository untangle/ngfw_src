Ext.define('Ung.util.Map', {
    ...
    columns: {
        ...
        bypasses:             { text: 'Bypass Count'.t(), width: 80 },
        ...
        connect_stamp:        { text: 'Login Time'.t(), width: 120 },
        ...
        dest_port:            { text: 'Destination Port'.t(), width: 200 },
        ...
        elapsed_time:         { text: 'Elapsed'.t(), width: 160 }, // converter
        ...
        gen_id:               { text: 'Gid'.t(), width: 100 },
        goodbye_stamp:        { text: 'Logout Time'.t(), width: 100 },
        hits:                 { text: 'Hit Count'.t(), width: 250 },
        hit_bytes:            { text: 'Hit Bytes'.t(), width: 250 },
        host:                 { text: 'Host'.t(), width: 250 },
        hostname:             { text: 'Hostname'.t(), width: 120 },
        icmp_type:            { text: 'ICMP Type'.t(), width: 150 }, // converter
        in_bytes:             { text: 'In Bytes'.t(), width: 200 },
        ...
        misses:               { text: 'Miss Count'.t(), width: 120 },
        miss_bytes:           { text: 'Miss Bytes'.t(), width: 120 },
        ...
        out_bytes:            { text: 'Out Bytes'.t(), width: 200 },
        ...
        remote_port:          { text: 'Remote Port'.t(), width: 120 },
        request_id:           { text: 'Request Id'.t(), width: 120 },
        rid:                  { text: 'Rid'.t(), width: 120 },
        rx_bytes:             { text: 'RX Bytes'.t(), width: 120 },
        rx_rate:              { text: 'RX Rate'.t(), width: 120 },
        ...
        success:              { text: 'Success'.t(), width: 100, renderer: Renderer2.boolean },
        ...
        systems:              { text: 'System Count'.t(), width: 160 },
        ...
        tx_bytes:             { text: 'TX Bytes'.t(), width: 160 },
        tx_rate:              { text: 'TX Rate'.t(), width: 120 },
