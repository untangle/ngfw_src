-- settings conversion for release-7.0.1
-- $HeadURL: svn://chef/work/src/protofilter/hier/usr/share/untangle/schema/untangle-node-protofilter/settings-convert-6.sql $
