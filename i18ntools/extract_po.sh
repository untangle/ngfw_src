...
for module in untangle-node-phish untangle-node-spam-blocker-lite untangle-node-shield untangle-node-protofilter untangle-node-idps untangle-node-firewall untangle-node-reporting untangle-node-openvpn untangle-node-adblocker
do
