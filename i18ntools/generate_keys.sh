...
"webfilter")
    ...
    # TODO change charset=utf-8 for pot file
    echo 'get new keys'
    xgettext --copyright-holder='Untangle, Inc.' -L Python -k.i18n._ -o tmpkeys.pot ../hier/usr/share/untangle/web/webui/script/untangle-node-$1/settings.js
...
"phish")
    ...
    echo 'get new keys'
    xgettext --copyright-holder='Untangle, Inc.' -L Python -k.i18n._ -o tmpkeys.pot ../hier/usr/share/untangle/web/webui/script/untangle-node-$1/settings.js
    msgcat tmpkeys.pot block_page_keys.pot -o tmpkeys.pot
    msgmerge -U ung_$1.pot tmpkeys.pot
    rm tmpkeys.pot
    echo 'update po files'
    msgmerge -U ro/ung_$1.po ung_$1.pot
