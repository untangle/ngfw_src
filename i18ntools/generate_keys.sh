...
"untangle-apache2-config")
    ...
    ;;
<<<<<<< .mine
"untangle-node-application-control-lite"|"untangle-node-intrusion-prevention"|"untangle-node-firewall"|"untangle-node-reporting"|"untangle-node-ad-blocker"|"untangle-node-spam-blocker-lite"|"untangle-node-captive-portal"|"untangle-base-web-filter"|"untangle-node-phish-blocker"|"untangle-node-openvpn"|"untangle-node-directory-connector"|"untangle-node-bandwidth-control"|"untangle-node-configuration-backup"|"untangle-node-faild"|"untangle-node-policy-manager"|"untangle-node-faild"|"untangle-node-wan-balancer"|"untangle-node-webcache"|"untangle-node-web-filter"|"untangle-node-spam-blocker"|"untangle-node-classd"|"untangle-node-branding-manager"|"untangle-node-ipsec-vpn"|"untangle-node-live-support"|"untangle-casing-ssl"|"untangle-casing-smtp"|"untangle-base-virus-blocker")
=======
"untangle-node-application-control-lite"|"untangle-node-intrusion-prevention"|"untangle-node-firewall"|"untangle-node-reporting"|"untangle-node-ad-blocker"|"untangle-node-spam-blocker-lite"|"untangle-node-captive-portal"|"untangle-base-web-filter"|"untangle-node-phish-blocker"|"untangle-node-openvpn"|"untangle-node-directory-connector"|"untangle-node-bandwidth-control"|"untangle-node-configuration-backup"|"untangle-node-wan-failover"|"untangle-node-policy-manager"|"untangle-node-wan-failover"|"untangle-node-wan-balancer"|"untangle-node-webcache"|"untangle-node-web-filter"|"untangle-node-spam-blocker"|"untangle-node-classd"|"untangle-node-branding-manager"|"untangle-node-ipsec"|"untangle-node-live-support"|"untangle-casing-ssl"|"untangle-casing-smtp"|"untangle-base-virus-blocker")
>>>>>>> .r41260
    app=`echo "$1"|cut -d"-" -f3`
    mid=`echo "$1"|cut -d"-" -f2`
    moduleName=""
