...
"untangle-libuvm")
    ...
    xgettext -j --copyright-holder='Untangle, Inc.' -L Java -kmarktr -o tmp_keys.pot ../../../../hades/src/spamblocker/impl/com/untangle/node/spamblocker/SpamBlockerNode.java
